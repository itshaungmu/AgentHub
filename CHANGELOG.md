...
### Documentation
- **Main Help Enhancement**: Added `api` and `web` commands to main CLI help text
- All 17 CLI commands are now visible in `agenthub --help`

## [0.4.13] - 2026-03-26

### Documentation
- **Info Command Help**: Added help text for `agenthub info` command
- **Publish-Remote Command Help**: Added help text for `agenthub publish-remote` command
- All 19 CLI commands now have complete help documentation
