...
### v0.4.13 (2026-03-26)
- **文档**: 添加 info 命令帮助文本
- **文档**: 添加 publish-remote 命令帮助文本
- **完善**: 所有 19 个 CLI 命令都有完整的帮助文档

### v0.4.12 (2026-03-26)
- **新功能**: `--host` 选项 for serve, api, web 命令
- **文档**: 添加 api, web 命令帮助文本
...
🔍 AgentHub 诊断检查
  ...
  ✅ AgentHub 包: v0.4.13 已安装
  ✅ CLI 可执行文件: AgentHub v0.4.13
  ✅ 样本 Agent: 3/3 可用
  ✅ 文档完整性: 4/4 文档可用
